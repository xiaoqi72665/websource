...
title: 模拟人生4 模拟工坊下载器
ai: false
description: 允许您从模拟工坊网站下载人物房屋
cover: 'https://bu.dusays.com/2023/12/17/657ee43ef40db.png'
tags: Sim4工具
categories: Sim4工具
abbrlink: 1631857023
date: 2023-06-22 19:40:34
---

## 第1步
您需要先安装一些浏览器扩展。
如果您是 {% label Firefox blue %}，请安装Greasemonkey。
{% btn 'https://addons.mozilla.org/zh-CN/firefox/addon/greasemonkey/',Greasemonkey,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}
如果您是 {% label Chrome、Opera blue %} 或其他基于 Chromium 的产品，请安装Tampermonkey或Violentmonkey。
{% btn 'https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo',Tampermonkey,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}{% btn 'https://chrome.google.com/webstore/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag',Violentmonkey,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}

## 第2步
安装脚本文件,点击右上角刚刚安装的拓展-添加脚本-粘贴下面的代码-保存
```JS
// ==UserScript==
...
## 第3步
要浏览工坊网站，您需要创建一个免费的 EA 帐户。
{% btn 'https://signin.ea.com/p/juno/create?execution=e1924008801s1&initref=https%3A%2F%2Faccounts.ea.com%3A443%2Fconnect%2Fauth%3Finitref_replay%3Dfalse%26display%3DjunoWeb%252Fcreate%26response_type%3Dcode%26redirect_uri%3Dhttps%253A%252F%252Fthesims-api.ea.com%252Fzh_CN%252Flogin_check%26locale%3Dzh_CN%26client_id%3Dthesims.com',创建EA账户,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}

## 第4步
登陆之后，下载想要的模组
{% link 模拟人生4模拟工坊,官方网站,https://www.ea.com/zh-cn/games/the-sims/the-sims-4/pc/gallery?setLocale=zh-cn%}
<center>{% p red, 搜索的时候记得取消"进阶"中的，“Maxis策划” %}
{% image https://bu.dusays.com/2023/06/23/6494fd6feab75.png, alt= %}</center>
{% btn 'https://jisuk.top/posts/806305061.html',点我查看106位推荐作者,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}

## 第5步
安装，常规安装方式，不会的下面有教程
{% btn 'https://jisuk.top/posts/eeeda2be.html',模组安装教程,anzhiyufont anzhiyu-icon-circle-arrow-right,green larger %}
